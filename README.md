...
| 1. Пустое окно | 2. Ввод текста Hello | 3. Результат дэшифрования Hello | 4. Расшифровка обратно в Hello |
|----------------|----------------------|--------------------------------|-------------------------------|
| ![пустое окно](1.png) | ![ввод Hello](2.png) | ![шифр Ifmmp](3.png) | ![расшифровка Hello](4.png) |
